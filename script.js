...
function fetchForecast(coords) {
  return new Promise(function(resolve,reject) {
    console.log(FORECAST_URL(coords));
...
function handleSubmit(e) {
  ...
  F.then(forecasts=>{
    ...
    hideLoader();
  }).catch(err=>displayError('There was an error fetching the weather forecast.'));
}
